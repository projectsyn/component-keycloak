...
----
instance=keycloak
vault kv put -cas=0 clusters/kv/${TENANT_ID}/${CLUSTER_ID}/keycloak ${instance}-admin-password=$(pwgen -s 32 1)
----
...
----
instance=keycloak
vault kv patch clusters/kv/${TENANT_ID}/${CLUSTER_ID}/keycloak ${instance}-db-password=$(pwgen -s 32 1)
----
