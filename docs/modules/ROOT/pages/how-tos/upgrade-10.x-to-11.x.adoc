...
* `charts.keycloakx` changed from `1.6.1` to `1.6.2`, the Keycloak image is updated from `18.0.2` to `19.0.3`.
* `charts.postgresql` changed from `12.0.0` to `12.1.0`, the Postgresql version changes from version `11.14.0-debian-10-r28` to `postgresql:11.17.0-debian-11-r37`.
