# Commodore Component: keycloak

This is a [Commodore][commodore] Component for keycloak.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/keycloak).
